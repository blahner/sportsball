...
bracket = { #values are the team names e.g. QuadNWTeamA
    ...
    "round1QuadSEH": 'QuadSETeam15',  #end round 1
    ...
    "round3QuadNEB": 'QuadNETeam6',

    "round3QuadSWA": 'QuadSWTeam1', 
    "round3QuadSWB": 'QuadSWTeam2',
    ...
    "round4QuadSWA": 'QuadSWTeam2', 
    "round4QuadSEA": 'QuadSETeam10',  #end round 4

    "round5SemiFinalsWest": 'QuadNWTeam2',  #start round 5
    "round5SemiFinalsEast": 'QuadNETeam1',  #end round 5

    "round6Finals": 'QuadNWTeam2' #round 6 finals
}
root = os.path.join("path","to","project","folder") # change to your path
save_root = os.path.join(root, "results","truth_brackets")
truth = {'2016': transform_bracket(bracket)}
with open(os.path.join(save_root, "truth_2016.pkl"),'wb') as f:
    pickle.dump(truth, f)