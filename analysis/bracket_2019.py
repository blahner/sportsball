...
bracket = { #values are the team names e.g. QuadNWTeamA
    ...
    "round4QuadSEA": 'QuadSETeam5',  #end round 4
...
truth = {'2019': transform_bracket(bracket)}
with open(os.path.join(save_root, "truth_2019.pkl"),'wb') as f:
    pickle.dump(truth, f)