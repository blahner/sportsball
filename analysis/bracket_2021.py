...
bracket = { #values are the team names e.g. QuadNWTeamA
    ...
    "round1QuadSWF": 'QuadSWTeam14', 
    "round1QuadSWG": 'QuadSWTeam10',
    ...
    "round2QuadSEA": 'QuadSETeam8', 
    "round2QuadSEB": 'QuadSETeam12', 
    "round2QuadSEC": 'QuadSETeam11', 
    "round2QuadSED": 'QuadSETeam2',  #end round 2

    "round3QuadNWA": 'QuadNWTeam1',  #start round 3
    "round3QuadNWB": 'QuadNWTeam6', 
    ...
    "round3QuadSEA": 'QuadSETeam12', 
    "round3QuadSEB": 'QuadSETeam2',  #end round 3

    "round4QuadNWA": 'QuadNWTeam1',  #start round 4
    "round4QuadNEA": 'QuadNETeam1', 
    "round4QuadSWA": 'QuadSWTeam11', 
    "round4QuadSEA": 'QuadSETeam2',  #end round 4

    "round5SemiFinalsWest": 'QuadNWTeam1',  #start round 5
...
truth = {'2021': transform_bracket(bracket)}
with open(os.path.join(save_root, "truth_2021.pkl"),'wb') as f:
    pickle.dump(truth, f)