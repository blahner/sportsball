...
const btn_womens = document.getElementById("btn_womens");
...
btn_womens.addEventListener("click", function () { //with each match, both the text (team name) and the ranking of the winning team need to propagate forward and get assigned to the next box.
